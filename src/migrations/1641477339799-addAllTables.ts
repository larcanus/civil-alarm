...
export class addAllTables1641477339799 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "production"."filters" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name_1" character varying NOT NULL DEFAULT 'фильтр №1', "filter_1" character varying NOT NULL DEFAULT '', "subject_1" character varying NOT NULL DEFAULT '', "active_1" boolean NOT NULL DEFAULT true, "name_2" character varying NOT NULL DEFAULT 'фильтр №2', "filter_2" character varying NOT NULL DEFAULT '', "subject_2" character varying NOT NULL DEFAULT '', "active_2" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_0a3564db8ce9b0dcb991598944c" PRIMARY KEY ("id"))`);
