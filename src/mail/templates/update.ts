export function fillHtml( credentials ) {
            ...
            <table>
                <tr>
                    <td align="center" class="masthead">
                        <h1>Ваши данные были изменены!</h1>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        ...
                        <p>
                           Данные Вашего профиля кто-то изменил. Если это были не вы, поменяйте пароль или сообщите на  
                           <a href="mailto:civilalarm-support@yandex.com">civilalarm-support@yandex.com</a> для восстановления доступа.
                        </p>
                        ...
                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="https://civilalarm.ru" class="button">Продолжить пользоваться!</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
            ...
            <table>
                <tr>
                    <td class="content footer" align="center">
                        ...
                        <p>По всем вопросам: <a href="mailto:civilalarm-support@yandex.com">civilalarm-support@yandex.com</a></p>
                    </td>
                </tr>
            </table>
        </td>
